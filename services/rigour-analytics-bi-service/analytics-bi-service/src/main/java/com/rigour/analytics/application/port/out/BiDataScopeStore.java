...
public interface BiDataScopeStore {
    ...
    void replace(String tenantId, String userId, Identity identity, List<Grant> grants, String actorId);
    void revoke(String tenantId, String userId, String actorId, String reason);
    boolean renewIfUnchanged(String tenantId, String userId, Identity previous, Identity refreshed, String actorId);
    SupplyDashboardFilterOptionsView filterOptions(String tenantId, List<String> regions, String ownerStaffCode);

    record Identity(String employeeCode, String ownerStaffCode, String iamBindingRef,
                    String hrEmployeeRef, String crmEmployeeRef, long userSecurityVersion,
                    long tenantPolicyVersion, Instant verifiedAt, Instant expiresAt) { }
