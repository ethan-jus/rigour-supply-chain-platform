...
public final class DhbApiModels {
    ...
    public record SyncRunCommand(Instant from, Instant to, Integer pageSize,
                                 String sourceObjectType, String sourceId, String syncScope) {
        public SyncRunCommand(Instant from, Instant to, Integer pageSize, String sourceObjectType, String sourceId) {
            this(from, to, pageSize, sourceObjectType, sourceId, null);
        }
    ...
    public record SyncRunView(UUID runId, UUID taskId, String status,
                              ...
                              long createdCount, long changedCount, long repairedCount,
                              String errorCode, String errorMessage) {
        /** 兼容旧字段口径：created/changed/repaired 为空时不产生歧义。 */
        public SyncRunView(UUID runId, UUID taskId, String status,
                           Instant windowFrom, Instant windowTo,
                           long fetchedCount, long acceptedCount,
                           long duplicateCount, long rejectedCount,
                           String errorCode, String errorMessage) {
            this(runId, taskId, status, windowFrom, windowTo, fetchedCount, acceptedCount,
                    duplicateCount, rejectedCount, 0, 0, 0, errorCode, errorMessage);
        }
    }
