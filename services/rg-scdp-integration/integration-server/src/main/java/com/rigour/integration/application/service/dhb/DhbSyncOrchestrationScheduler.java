...
public final class DhbSyncOrchestrationScheduler {
    ...
    private final DhbContinuousOrderSyncService continuous;

    public DhbSyncOrchestrationScheduler(DhbSyncOrchestrationService service,
                                         DhbSyncOrchestrationProperties properties,DhbContinuousOrderSyncService continuous) {
    ...
    public void synchronize() {
        ...
        try {
            DhbSyncOrchestrationResult result = service.runScheduledMasterData();
