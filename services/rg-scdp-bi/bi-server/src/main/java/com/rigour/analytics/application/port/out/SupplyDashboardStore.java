...
public interface SupplyDashboardStore {
    ...
    SourceRefreshResult refreshCustomerDim(
            String tenantId, Instant from, Instant to, Instant syncedAt);

    SourceRefreshResult refreshSalesOrderFact(
            String tenantId, Instant from, Instant to, Instant syncedAt);

    SourceRefreshResult refreshSalesOrderLineFact(
            String tenantId, Instant from, Instant to, Instant syncedAt);

    SourceRefreshResult refreshProductDim(
            String tenantId, Instant from, Instant to, Instant syncedAt);
    ...
    SourceRefreshResult refreshReconciliationCurrent(
            String tenantId, Instant from, Instant to, Instant observedAt);

    CityCostImportResult importCityCostRecords(
            String tenantId, List<CityCostImportRow> rows, Instant importedAt);

    FeishuArchiveRow registerFeishuArchive(
    ...
    record SupplyDashboardData(
        ...
        public SupplyDashboardData {
            ...
            salesMonthlyPerformance =
                    List.copyOf(
                            salesMonthlyPerformance == null ? List.of() : salesMonthlyPerformance);
            cityCollectionRateRanking =
                    List.copyOf(
                            cityCollectionRateRanking == null
                                    ? List.of()
                                    : cityCollectionRateRanking);
            sourceSystemBreakdown =
                    List.copyOf(sourceSystemBreakdown == null ? List.of() : sourceSystemBreakdown);
            productSalesRanking =
                    List.copyOf(productSalesRanking == null ? List.of() : productSalesRanking);
            skuSalesRanking = List.copyOf(skuSalesRanking == null ? List.of() : skuSalesRanking);
            categorySalesRanking =
                    List.copyOf(categorySalesRanking == null ? List.of() : categorySalesRanking);
            brandSalesRanking =
                    List.copyOf(brandSalesRanking == null ? List.of() : brandSalesRanking);
            paymentRiskCityRanking =
                    List.copyOf(
                            paymentRiskCityRanking == null ? List.of() : paymentRiskCityRanking);
            paymentRiskSalesRanking =
                    List.copyOf(
                            paymentRiskSalesRanking == null ? List.of() : paymentRiskSalesRanking);
            paymentAgingBuckets =
                    List.copyOf(paymentAgingBuckets == null ? List.of() : paymentAgingBuckets);
            cityTargetCompletions =
                    List.copyOf(cityTargetCompletions == null ? List.of() : cityTargetCompletions);
            salesTargetCompletions =
                    List.copyOf(
                            salesTargetCompletions == null ? List.of() : salesTargetCompletions);
            customerSegments = List.copyOf(customerSegments == null ? List.of() : customerSegments);
            customerActivityRanking =
                    List.copyOf(
                            customerActivityRanking == null ? List.of() : customerActivityRanking);
            customerChurnRiskRanking =
                    List.copyOf(
                            customerChurnRiskRanking == null
                                    ? List.of()
                                    : customerChurnRiskRanking);
            inventoryItemSummary =
                    List.copyOf(inventoryItemSummary == null ? List.of() : inventoryItemSummary);
            inventoryReplenishment =
                    List.copyOf(
                            inventoryReplenishment == null ? List.of() : inventoryReplenishment);
    ...
    record CustomerSummary(
            Long activeCustomerCount, Long contactedCustomerCount, Instant latestUpdatedTime) {
    ...
    record CollectionSummary(
            Long paymentCount, BigDecimal receiptAmount, Instant latestUpdatedTime) {
    ...
    record PaymentRiskSummary(
        ...
        static PaymentRiskSummary empty() {
            return new PaymentRiskSummary(
                    BigDecimal.ZERO, 0L, 0L, BigDecimal.ZERO, BigDecimal.ZERO, null);
        }
    }
    ...
    record TrendPoint(
            String metricCode, String period, BigDecimal value, BigDecimal secondaryValue) {}
    ...
    record ReconciliationData(
            Instant from, Instant to, Instant observedAt, List<ReconciliationItem> items) {
    ...
    record FilterOptions(
        ...
        public FilterOptions {
            ...
            productCategories =
                    List.copyOf(productCategories == null ? List.of() : productCategories);
    ...
    record FilterOption(
            ...
            Long ordinal) {
        public FilterOption(
                String optionType, String optionValue, String optionLabel, Long usageCount) {
