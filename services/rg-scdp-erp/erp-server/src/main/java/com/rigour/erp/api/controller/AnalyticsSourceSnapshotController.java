package com.rigour.erp.api.controller;

import com.rigour.erp.api.v1.AnalyticsSourceSnapshotApi;
...
public final class AnalyticsSourceSnapshotController implements AnalyticsSourceSnapshotApi {
    ...
    private String tenant() {
        ...
        AuthorizationContext.requirePermission("erp:analytics:source-read");
