...
public class MybatisPlusInventoryWarehouseRepository
    ...
    public MybatisPlusInventoryWarehouseRepository(
            InternalInventoryWarehouseMapper mapper, Clock erpClock, ErpWarehouseDataScope scopes) {
    ...
    public MasterDataPageView<InternalInventoryWarehouseView> warehouses(
        ...
        List<InternalInventoryWarehouseView> items =
                mapper
                        .selectList(
                                query(tenantId, criteria)
                                        .orderByDesc(
                                                InternalInventoryWarehouseEntity::getDefaultFlag)
                                        .orderByDesc(
                                                InternalInventoryWarehouseEntity::getUpdatedTime)
    ...
    public Optional<InternalInventoryWarehouseView> warehouse(String tenantId, Long id) {
        if (!scopes.visibleDocument(
                tenantId, id, "erp_inventory_warehouse", "erp:warehouse:read", "id"))
        ...
        return getBaseMapper()
                        .selectCount(
                                Wrappers.<InternalInventoryWarehouseEntity>lambdaQuery()
                                        ...
                                        .eq(
                                                InternalInventoryWarehouseEntity::getWarehouseCode,
                                                warehouseCode))
                > 0;
    }
    ...
    public InternalInventoryWarehouseView create(
            String tenantId,
            String warehouseCode,
            InternalInventoryWarehouseCommand command,
            String actorId) {
        scopes.requireAll("erp:warehouse:create");
    ...
    @Override
    @Transactional(rollbackFor = Exception.class)
    public InternalInventoryWarehouseView update(
            String tenantId, Long id, InternalInventoryWarehouseCommand command, String actorId) {
        scopes.requireWarehouse(tenantId, id, "erp:warehouse:update");
        ...
        int updated =
                getBaseMapper()
                        .update(
                                null,
                                Wrappers.<InternalInventoryWarehouseEntity>lambdaUpdate()
                                        .set(
                                                InternalInventoryWarehouseEntity::getWarehouseName,
                                                command.warehouseName())
                                        .set(
                                                InternalInventoryWarehouseEntity::getRegionCode,
                                                command.regionCode())
                                        .set(
                                                InternalInventoryWarehouseEntity
                                                        ::getWarehouseTypeCode,
                                                command.warehouseTypeCode())
                                        .set(
                                                InternalInventoryWarehouseEntity::getDefaultFlag,
                                                command.defaultFlag())
                                        .set(
                                                InternalInventoryWarehouseEntity::getAddress,
                                                command.address())
                                        .set(
                                                InternalInventoryWarehouseEntity::getContactName,
                                                command.contactName())
                                        .set(
                                                InternalInventoryWarehouseEntity::getContactPhone,
                                                command.contactPhone())
                                        .set(
                                                InternalInventoryWarehouseEntity::getStatusCode,
                                                command.statusCode())
                                        .set(
                                                InternalInventoryWarehouseEntity::getRemark,
                                                command.remark())
                                        .set(
                                                InternalInventoryWarehouseEntity::getRevision,
                                                command.revision() + 1)
                                        .set(
                                                InternalInventoryWarehouseEntity::getUpdatedBy,
                                                actorId)
    ...
    public void delete(String tenantId, Long id, int revision, String actorId) {
        scopes.requireWarehouse(tenantId, id, "erp:warehouse:delete");
        requireActive(tenantId, id);
        LocalDateTime now = now();
        int updated =
                getBaseMapper()
    ...
    private LambdaQueryWrapper<InternalInventoryWarehouseEntity> query(
        ...
        if (criteria.warehouseCode() != null) {
            query.like(
                    InternalInventoryWarehouseEntity::getWarehouseCode, criteria.warehouseCode());
        }
        if (criteria.warehouseName() != null) {
            query.like(
                    InternalInventoryWarehouseEntity::getWarehouseName, criteria.warehouseName());
        }
        ...
        scopes.apply(query, "erp:warehouse:read", "id");
        return query;
    }

    private void clearOtherDefaultWarehouses(
            String tenantId, Long currentId, String actorId, LocalDateTime now) {
        if (currentId != null) scopes.requireAll("erp:warehouse:update");
        var update =
                Wrappers.<InternalInventoryWarehouseEntity>lambdaUpdate()
    ...
    private static InternalInventoryWarehouseView view(InternalInventoryWarehouseEntity entity) {
        return new InternalInventoryWarehouseView(
                entity.getId(),
                entity.getWarehouseCode(),
                entity.getWarehouseName(),
                entity.getRegionCode(),
                entity.getWarehouseTypeCode(),
                entity.getDefaultFlag(),
                entity.getAddress(),
