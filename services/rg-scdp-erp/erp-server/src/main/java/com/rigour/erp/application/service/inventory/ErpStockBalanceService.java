...
public final class ErpStockBalanceService {
    ...
    public MasterDataPageView<InternalStockBalanceView> stockBalances(
        ...
        StockBalanceSearchCriteria criteria =
                new StockBalanceSearchCriteria(
        ...
        MasterDataPageView<InternalStockBalanceView> result =
                store.stockBalances(
                        tenantId,
                        ...
                        criteria);
        log.debug(
                "ERP库存余额查询完成 tenantId={} productCode={} productName={} warehouseId={}"
                    + " warehouseName={} count={} total={}",
                tenantId,
