...
class MybatisPlusStockInOrderRepositoryTest {
    ...
    private final InternalSupplierProfileMapper supplierMapper =
            mock(InternalSupplierProfileMapper.class);
    private final InternalInventoryWarehouseMapper warehouseMapper =
            mock(InternalInventoryWarehouseMapper.class);
    private final MybatisPlusStockInOrderRepository repository =
            new MybatisPlusStockInOrderRepository(
                    stockInMapper,
                    stockInLineMapper,
                    procurementOrderMapper,
                    procurementLineMapper,
                    stockBalanceMapper,
                    stockFlowMapper,
                    supplierMapper,
                    warehouseMapper,
                    Clock.fixed(Instant.parse("2026-08-26T00:00:00Z"), ZoneOffset.UTC),
                    new ErpWarehouseDataScope(
                            mock(com.rigour.tenant.iam.client.SupplyAuthorizationClient.class),
    ...
    void stockInOrdersSupportsSynchronizedTransferRowsWithoutSupplier() {
        ...
        var result =
                repository.stockInOrders(
                        TENANT_ID,
                        0,
                        20,
                        new com.rigour.erp.application.port.out.ErpStockInOrderStore
                                .StockInOrderSearchCriteria(
        ...
        assertThat(result.items())
                ...
                .satisfies(
                        item -> {
                            ...
                            assertThat(item.stockInTypeCode())
                                    .isEqualTo(ErpStockInType.TRANSFER.code());
    ...
    void stockInOrdersMatchesInternalNoSourceNoRelationsAndRemark() {
        ...
        repository.stockInOrders(
                ...
                new StockInOrderSearchCriteria(
                        "RK.20260826.0091", null, null, null, null, null, null, null));
