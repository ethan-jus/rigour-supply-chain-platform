...
import com.rigour.tenant.iam.application.service.identity.IamBiIdentityService;
...
public final class IamBiIdentityController implements IamBiIdentityApi {
    ...
    @Override public IamBiIdentityView identity(UUID userId) {
        ...
        var identity = service.read(new IdentityAccessQuery("TENANT", UUID.fromString(jwt.getClaimAsString("principalId")),
