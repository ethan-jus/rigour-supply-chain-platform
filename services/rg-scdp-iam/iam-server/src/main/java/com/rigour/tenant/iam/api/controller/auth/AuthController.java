...
public final class AuthController {
    ...
    public ResponseEntity<String> loginPage(
        ...
        String html = """
                ...
                <link rel="icon" type="image/png" href="/brand/scdp-logo.png"><link rel="apple-touch-icon" href="/brand/scdp-logo.png">
                <meta name="color-scheme" content="light"><title>瑞盖供应链数字化平台</title><style>
                *{box-sizing:border-box}body{margin:0;min-height:100vh;font-family:"PingFang SC","Microsoft YaHei",system-ui,-apple-system,sans-serif;color:#0f172a;background:#fff}
                ...
                <div class="logo"><img src="/brand/scdp-logo.png" alt="瑞盖供应链数字化平台"><span>瑞盖供应链数字化平台</span></div>
                <div class="intro"><p class="eyebrow">RIGOUR SCDP</p><h1>瑞盖供应链<br>数字化平台</h1><p>连接客户、订单与库存，让业务高效协同。</p></div>
                <div class="capabilities"><span>多租户隔离</span><span>客户与订单管理</span><span>角色与数据权限</span></div></section>
        ...
        return ResponseEntity.ok()
                ...
                .header("Content-Security-Policy",
                        "default-src 'none'; img-src 'self'; style-src 'unsafe-inline'; script-src 'nonce-" + scriptNonce
                                + "'; form-action 'self' " + scdpFormActions
