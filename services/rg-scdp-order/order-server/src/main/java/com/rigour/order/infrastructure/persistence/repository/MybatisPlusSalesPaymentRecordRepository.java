...
public class MybatisPlusSalesPaymentRecordRepository
    ...
    public OrderPageView<SalesPaymentRecordSummaryView> payments(
        ...
        List<SalesPaymentRecordSummaryView> items =
                getBaseMapper()
                        .selectList(
    ...
    public Optional<SalesPaymentRecordDetailView> payment(String tenantId, Long id) {
        if (!scopes.visibleRelated(tenantId, id, "order:payment:read", "order_payment_record"))
            return Optional.empty();
        return rawDetail(tenantId, id);
    }

    private Optional<SalesPaymentRecordDetailView> rawDetail(String tenantId, Long id) {
    ...
    public Optional<SalesPaymentRecordDetailView> paymentBySource(
        ...
        scopes.applyRelated(query, "order:payment:read", "order_payment_record");
                                ...
                                .selectOne(
                                        query.orderByDesc(
                                                        InternalSalesPaymentRecordEntity
                                                                ::getUpdatedTime)
                                                .orderByDesc(
                                                        InternalSalesPaymentRecordEntity::getId)
                                                .last("LIMIT 1")))
        ...
        return getBaseMapper()
                        .selectCount(
                                Wrappers.<InternalSalesPaymentRecordEntity>lambdaQuery()
                                        .eq(InternalSalesPaymentRecordEntity::getTenantId, tenantId)
                                        .eq(
                                                InternalSalesPaymentRecordEntity::getPaymentNo,
                                                paymentNo))
                > 0;
    }
    ...
    public SalesPaymentRecordDetailView create(
        ...
        scopes.requireRelatedOrder(tenantId, command.orderId(), "order:payment:create");
        requireOrder(tenantId, command.orderId());
        LocalDateTime now = now();
        InternalSalesPaymentRecordEntity entity =
                entity(tenantId, paymentNo, command, actorId, now);
        try {
        ...
        return rawDetail(tenantId, entity.getId()).orElseThrow(() -> notFound("销售回款记录不存在"));
    }
    ...
    public SalesPaymentRecordDetailView update(
        ...
        scopes.requireRelated(tenantId, id, "order:payment:update", "order_payment_record");
        scopes.requireRelatedOrder(tenantId, command.orderId(), "order:payment:update");
        InternalSalesPaymentRecordEntity existing =
                selectActive(tenantId, id).orElseThrow(() -> notFound("销售回款记录不存在"));
        requireOrder(tenantId, command.orderId());
        ...
        var update =
                Wrappers.<InternalSalesPaymentRecordEntity>lambdaUpdate()
                                        ...
                                        .set(
                                                InternalSalesPaymentRecordEntity::getOrderId,
                                                command.orderId())
                                        .set(
                                                InternalSalesPaymentRecordEntity
                                        ...
                                        .set(
                                                InternalSalesPaymentRecordEntity::getCustomerId,
                                                command.customerId())
                                        .set(
                                                InternalSalesPaymentRecordEntity
                                        ...
                                        .set(
                                                InternalSalesPaymentRecordEntity
                                                        ::getCollectorStaffCode,
                                                command.collectorStaffCode())
                                        .set(
                                                InternalSalesPaymentRecordEntity
                                                        ::getCollectorNameSnapshot,
                                        ...
                                        .set(
                                                InternalSalesPaymentRecordEntity::getPaidAmount,
                                                command.paidAmount())
                                        .set(
                                                InternalSalesPaymentRecordEntity
                                                        ::getVoucherKeysJson,
                                        ...
                                        .set(
                                                ...
                                                command.remark())
                                        .set(
                                                InternalSalesPaymentRecordEntity::getRevision,
                                                command.revision() + 1)
                                        .set(
        ...
        return rawDetail(tenantId, id).orElseThrow(() -> notFound("销售回款记录不存在"));
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public void delete(String tenantId, Long id, int revision, String actorId) {
        scopes.requireRelated(tenantId, id, "order:payment:delete", "order_payment_record");
        InternalSalesPaymentRecordEntity existing =
                selectActive(tenantId, id).orElseThrow(() -> notFound("销售回款记录不存在"));
        LocalDateTime now = now();
        int updated =
    ...
    private LambdaQueryWrapper<InternalSalesPaymentRecordEntity> query(
        ...
        LambdaQueryWrapper<InternalSalesPaymentRecordEntity> query =
                Wrappers.<InternalSalesPaymentRecordEntity>lambdaQuery()
                        .eq(InternalSalesPaymentRecordEntity::getTenantId, tenantId)
                        .eq(InternalSalesPaymentRecordEntity::getDeleted, 0);
        if (criteria.paymentNo() != null)
            query.like(InternalSalesPaymentRecordEntity::getPaymentNo, criteria.paymentNo());
        if (criteria.salesOrderNo() != null)
            query.like(
                    InternalSalesPaymentRecordEntity::getSalesOrderNoSnapshot,
                    criteria.salesOrderNo());
        if (criteria.sourceDocumentNo() != null)
            query.like(
                    InternalSalesPaymentRecordEntity::getSourceDocumentNo,
                    criteria.sourceDocumentNo());
        if (criteria.customerName() != null)
            query.like(
                    InternalSalesPaymentRecordEntity::getCustomerNameSnapshot,
                    criteria.customerName());
        if (criteria.collectorStaffCode() != null)
            query.eq(
                    InternalSalesPaymentRecordEntity::getCollectorStaffCode,
                    criteria.collectorStaffCode());
        if (criteria.paymentMethodCode() != null)
            query.eq(
                    InternalSalesPaymentRecordEntity::getPaymentMethodCode,
                    criteria.paymentMethodCode());
        if (criteria.paymentTimeFrom() != null)
            query.ge(
                    InternalSalesPaymentRecordEntity::getPaymentTime,
                    local(criteria.paymentTimeFrom()));
        if (criteria.paymentTimeTo() != null)
            query.le(
                    InternalSalesPaymentRecordEntity::getPaymentTime,
                    local(criteria.paymentTimeTo()));
        return scopes.applyRelated(query, "order:payment:read", "order_payment_record");
    }

    private InternalSalesPaymentRecordEntity entity(
            String tenantId,
            String paymentNo,
            SalesPaymentWrite command,
            String actorId,
            LocalDateTime now) {
    ...
    private void refreshOrderPayment(
            String tenantId, Long orderId, String actorId, LocalDateTime now) {
        if(orderMapper.historyMemberCount(tenantId,orderId)>0)
            throw new IllegalArgumentException("已接续历史订单必须通过回款核对账本变更，普通回款/退款操作不会覆盖期初余额");
        InternalSalesOrderEntity order = requireOrder(tenantId, orderId);
        List<InternalSalesPaymentRecordEntity> payments =
                getBaseMapper()
                        .selectList(
                                Wrappers.<InternalSalesPaymentRecordEntity>lambdaQuery()
                                        .eq(InternalSalesPaymentRecordEntity::getTenantId, tenantId)
                ...
                refundMapper
                        .selectList(
                                Wrappers.<InternalSalesRefundRecordEntity>lambdaQuery()
                                        ...
                                        .ne(
                                                InternalSalesRefundRecordEntity
                                                        ::getRefundStatusCode,
                                                SalesRefundStatus.CANCELLED.code())
        ...
        boolean cancelledOrder =
                SalesOrderStatus.CANCELLED.code().equals(order.getOrderStatusCode());
    ...
    private static BigDecimal unpaidAmount(
            InternalSalesOrderEntity order,
            boolean cancelledOrder,
    ...
    private static SalesPaymentRecordSummaryView summary(InternalSalesPaymentRecordEntity entity) {
        return new SalesPaymentRecordSummaryView(
                entity.getId(),
                entity.getPaymentNo(),
                ...
                entity.getCollectorStaffCode(),
                entity.getCollectorNameSnapshot(),
