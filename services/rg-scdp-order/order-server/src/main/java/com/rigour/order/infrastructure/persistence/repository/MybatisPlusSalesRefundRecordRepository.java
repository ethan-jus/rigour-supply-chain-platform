...
public class MybatisPlusSalesRefundRecordRepository
    ...
    public OrderPageView<SalesRefundRecordSummaryView> refunds(
        ...
        List<SalesRefundRecordSummaryView> items =
                getBaseMapper()
                        .selectList(
    ...
    public Optional<SalesRefundRecordDetailView> refund(String tenantId, Long id) {
        if (!scopes.visibleRelated(tenantId, id, "order:refund:read", "order_refund_record"))
            return Optional.empty();
        return rawDetail(tenantId, id);
    }

    private Optional<SalesRefundRecordDetailView> rawDetail(String tenantId, Long id) {
        ...
        return getBaseMapper()
                        .selectCount(
                                Wrappers.<InternalSalesRefundRecordEntity>lambdaQuery()
                                        ...
                                        .eq(InternalSalesRefundRecordEntity::getRefundNo, refundNo))
                > 0;
    }
    ...
    public SalesRefundRecordDetailView create(
        ...
        scopes.requireRelatedOrder(tenantId, command.orderId(), "order:refund:create");
        ...
        return rawDetail(tenantId, entity.getId()).orElseThrow(() -> notFound("销售退款记录不存在"));
    }
    ...
    public SalesRefundRecordDetailView update(
        ...
        scopes.requireRelated(tenantId, id, "order:refund:update", "order_refund_record");
        scopes.requireRelatedOrder(tenantId, command.orderId(), "order:refund:update");
        InternalSalesRefundRecordEntity existing =
                selectActive(tenantId, id).orElseThrow(() -> notFound("销售退款记录不存在"));
        requireOrder(tenantId, command.orderId());
        ...
        int updated =
                getBaseMapper()
                        .update(
                                null,
                                Wrappers.<InternalSalesRefundRecordEntity>lambdaUpdate()
                                        .set(
                                                InternalSalesRefundRecordEntity::getOrderId,
                                                command.orderId())
                                        .set(
                                        ...
                                        .set(
                                                InternalSalesRefundRecordEntity::getCustomerId,
                                                command.customerId())
                                        .set(
                                                InternalSalesRefundRecordEntity
                                        ...
                                        .set(
                                                InternalSalesRefundRecordEntity::getRefundStaffCode,
                                                command.refundStaffCode())
                                        .set(
                                                InternalSalesRefundRecordEntity
                                                        ::getRefundStaffNameSnapshot,
                                                command.refundStaffNameSnapshot())
                                        .set(
                                                InternalSalesRefundRecordEntity::getRefundTime,
                                                local(command.refundTime()))
                                        .set(
                                                InternalSalesRefundRecordEntity
                                                        ::getRefundMethodCode,
                                        ...
                                        .set(
                                                InternalSalesRefundRecordEntity::getRefundAmount,
                                                command.refundAmount())
                                        .set(
                                                InternalSalesRefundRecordEntity::getVoucherKeysJson,
                                                json(command.voucherKeys()))
                                        .set(
                                                InternalSalesRefundRecordEntity::getRemark,
                                                command.remark())
                                        .set(
                                                InternalSalesRefundRecordEntity::getRevision,
                                                command.revision() + 1)
        ...
        return rawDetail(tenantId, id).orElseThrow(() -> notFound("销售退款记录不存在"));
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public void delete(String tenantId, Long id, int revision, String actorId) {
        scopes.requireRelated(tenantId, id, "order:refund:delete", "order_refund_record");
        InternalSalesRefundRecordEntity existing =
                selectActive(tenantId, id).orElseThrow(() -> notFound("销售退款记录不存在"));
        LocalDateTime now = now();
        int updated =
    ...
    private LambdaQueryWrapper<InternalSalesRefundRecordEntity> query(
        ...
        LambdaQueryWrapper<InternalSalesRefundRecordEntity> query =
                Wrappers.<InternalSalesRefundRecordEntity>lambdaQuery()
                        .eq(InternalSalesRefundRecordEntity::getTenantId, tenantId)
                        .eq(InternalSalesRefundRecordEntity::getDeleted, 0);
        if (criteria.refundNo() != null)
            query.like(InternalSalesRefundRecordEntity::getRefundNo, criteria.refundNo());
        if (criteria.salesOrderNo() != null)
            query.like(
                    InternalSalesRefundRecordEntity::getSalesOrderNoSnapshot,
                    criteria.salesOrderNo());
        if (criteria.customerName() != null)
            query.like(
                    InternalSalesRefundRecordEntity::getCustomerNameSnapshot,
                    criteria.customerName());
        if (criteria.refundStaffCode() != null)
            query.eq(
                    InternalSalesRefundRecordEntity::getRefundStaffCode,
                    criteria.refundStaffCode());
        if (criteria.refundMethodCode() != null)
            query.eq(
                    InternalSalesRefundRecordEntity::getRefundMethodCode,
                    criteria.refundMethodCode());
        if (criteria.refundStatusCode() != null)
            query.eq(
                    InternalSalesRefundRecordEntity::getRefundStatusCode,
                    criteria.refundStatusCode());
        if (criteria.refundTimeFrom() != null)
            query.ge(
                    InternalSalesRefundRecordEntity::getRefundTime,
                    local(criteria.refundTimeFrom()));
        if (criteria.refundTimeTo() != null)
            query.le(
                    InternalSalesRefundRecordEntity::getRefundTime, local(criteria.refundTimeTo()));
        return scopes.applyRelated(query, "order:refund:read", "order_refund_record");
    }

    private InternalSalesRefundRecordEntity entity(
            String tenantId,
            String refundNo,
            SalesRefundWrite command,
            String actorId,
            LocalDateTime now) {
    ...
    private static SalesRefundRecordSummaryView summary(InternalSalesRefundRecordEntity entity) {
        return new SalesRefundRecordSummaryView(
                entity.getId(),
                entity.getRefundNo(),
                entity.getOrderId(),
                ...
                entity.getRefundStaffCode(),
                entity.getRefundStaffNameSnapshot(),
                instant(entity.getRefundTime()),
                entity.getRefundMethodCode(),
                entity.getRefundStatusCode(),
