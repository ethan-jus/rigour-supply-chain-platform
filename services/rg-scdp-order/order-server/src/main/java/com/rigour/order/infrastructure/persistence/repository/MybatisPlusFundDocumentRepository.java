...
public class MybatisPlusFundDocumentRepository
    ...
    public MybatisPlusFundDocumentRepository(
            InternalFundDocumentMapper mapper, Clock orderClock, OrderDataScope scopes) {
    ...
    public OrderPageView<FundDocumentSummaryView> fundDocuments(
        ...
        List<FundDocumentSummaryView> items =
                getBaseMapper()
                        .selectList(
    ...
    public Optional<FundDocumentDetailView> fundDocument(String tenantId, Long id) {
        if (!scopes.visibleRelated(tenantId, id, "order:fund:read", "order_fund_document"))
            return Optional.empty();
        return rawDetail(tenantId, id);
    }

    private Optional<FundDocumentDetailView> rawDetail(String tenantId, Long id) {
        ...
        return getBaseMapper()
                        .selectCount(
                                Wrappers.<InternalFundDocumentEntity>lambdaQuery()
                                        ...
                                        .eq(InternalFundDocumentEntity::getDocumentNo, documentNo))
                > 0;
    }
    ...
    public FundDocumentDetailView create(
        ...
        scopes.requireRelatedOrder(tenantId, command.relatedOrderId(), "order:fund:create");
        ...
        return rawDetail(tenantId, entity.getId()).orElseThrow(() -> notFound("资金单据不存在"));
    }
    ...
    public FundDocumentDetailView update(
        ...
        scopes.requireRelated(tenantId, id, "order:fund:update", "order_fund_document");
        scopes.requireRelatedOrder(tenantId, command.relatedOrderId(), "order:fund:update");
        InternalFundDocumentEntity existing =
                selectActive(tenantId, id).orElseThrow(() -> notFound("资金单据不存在"));
        scopes.requireStableAssociation(existing.getRelatedOrderId(), command.relatedOrderId());
        LocalDateTime now = now();
        int updated =
                getBaseMapper()
                        .update(
                                null,
                                Wrappers.<InternalFundDocumentEntity>lambdaUpdate()
                                        .set(
                                                InternalFundDocumentEntity::getConnectorId,
                                                uuidText(command.connectorId()))
                                        .set(
                                                InternalFundDocumentEntity::getSourceSystemCode,
                                                command.sourceSystemCode())
                                        .set(
                                                InternalFundDocumentEntity::getDirectionCode,
                                                command.directionCode())
                                        .set(
                                                InternalFundDocumentEntity::getRelatedOrderId,
                                                command.relatedOrderId())
                                        .set(
                                                InternalFundDocumentEntity::getSalesOrderNoSnapshot,
                                                command.salesOrderNoSnapshot())
                                        .set(
                                                InternalFundDocumentEntity::getCustomerId,
                                                command.customerId())
                                        .set(
                                                InternalFundDocumentEntity::getCustomerCodeSnapshot,
                                                command.customerCodeSnapshot())
                                        .set(
                                                InternalFundDocumentEntity::getCustomerNameSnapshot,
                                                command.customerNameSnapshot())
                                        .set(
                                                InternalFundDocumentEntity::getCounterpartyTypeCode,
                                                command.counterpartyTypeCode())
                                        .set(
                                                InternalFundDocumentEntity
                                                        ::getCounterpartyCodeSnapshot,
                                                command.counterpartyCodeSnapshot())
                                        .set(
                                                InternalFundDocumentEntity
                                                        ::getCounterpartyNameSnapshot,
                                                command.counterpartyNameSnapshot())
                                        .set(
                                                InternalFundDocumentEntity::getHandlerStaffCode,
                                                command.handlerStaffCode())
                                        .set(
                                                InternalFundDocumentEntity
                                                        ::getHandlerStaffNameSnapshot,
                                                command.handlerStaffNameSnapshot())
                                        .set(
                                                InternalFundDocumentEntity::getOccurredTime,
                                                local(command.occurredTime()))
                                        .set(
                                                InternalFundDocumentEntity::getSettlementMethodCode,
                                                command.settlementMethodCode())
                                        .set(
                                                InternalFundDocumentEntity::getBusinessTypeCode,
                                                command.businessTypeCode())
                                        .set(
                                                InternalFundDocumentEntity::getDocumentStatusCode,
                                                command.documentStatusCode())
                                        .set(
                                                InternalFundDocumentEntity::getAmount,
                                                command.amount())
                                        .set(
                                                InternalFundDocumentEntity::getSourceDocumentNo,
                                                command.sourceDocumentNo())
                                        .set(
                                                InternalFundDocumentEntity::getSourceOrderNo,
                                                command.sourceOrderNo())
                                        .set(
                                                InternalFundDocumentEntity::getPaymentSerialNo,
                                                command.paymentSerialNo())
                                        .set(
                                                InternalFundDocumentEntity::getBankAccountName,
                                                command.bankAccountName())
                                        .set(
                                                InternalFundDocumentEntity::getBankName,
                                                command.bankName())
                                        .set(
                                                InternalFundDocumentEntity::getBankAccountNo,
                                                command.bankAccountNo())
                                        .set(
                                                InternalFundDocumentEntity::getSubmittedAt,
                                                local(command.submittedAt()))
                                        .set(
                                                InternalFundDocumentEntity::getConfirmedAt,
                                                local(command.confirmedAt()))
                                        .set(
                                                InternalFundDocumentEntity
                                                        ::getSourceAttachmentKeysJson,
                                                json(command.sourceAttachmentKeys()))
                                        .set(
                                                InternalFundDocumentEntity::getVoucherKeysJson,
                                                json(command.voucherKeys()))
                                        .set(
                                                InternalFundDocumentEntity::getRemark,
                                                command.remark())
                                        .set(
                                                InternalFundDocumentEntity::getRevision,
                                                command.revision() + 1)
        ...
        return rawDetail(tenantId, id).orElseThrow(() -> notFound("资金单据不存在"));
    }

    @Override
    @Transactional(rollbackFor = Exception.class)
    public void delete(String tenantId, Long id, int revision, String actorId) {
        scopes.requireRelated(tenantId, id, "order:fund:delete", "order_fund_document");
        InternalFundDocumentEntity existing =
                selectActive(tenantId, id).orElseThrow(() -> notFound("资金单据不存在"));
        LocalDateTime now = now();
        int updated =
    ...
    private LambdaQueryWrapper<InternalFundDocumentEntity> query(
        ...
        if (criteria.keyword() != null) {
            query.and(
                    wrapper ->
                            wrapper.like(
                                            InternalFundDocumentEntity::getDocumentNo,
                                            criteria.keyword())
                                    .or()
                                    .like(
                                            InternalFundDocumentEntity::getSourceDocumentNo,
        ...
        if (criteria.directionCode() != null)
            query.eq(InternalFundDocumentEntity::getDirectionCode, criteria.directionCode());
        if (criteria.documentNo() != null)
            query.like(InternalFundDocumentEntity::getDocumentNo, criteria.documentNo());
        if (criteria.sourceDocumentNo() != null)
            query.like(
                    InternalFundDocumentEntity::getSourceDocumentNo, criteria.sourceDocumentNo());
        if (criteria.salesOrderNo() != null)
            query.like(
                    InternalFundDocumentEntity::getSalesOrderNoSnapshot, criteria.salesOrderNo());
        if (criteria.sourceOrderNo() != null)
            query.like(InternalFundDocumentEntity::getSourceOrderNo, criteria.sourceOrderNo());
        if (criteria.paymentSerialNo() != null)
            query.like(InternalFundDocumentEntity::getPaymentSerialNo, criteria.paymentSerialNo());
        if (criteria.counterpartyName() != null)
            query.like(
                    InternalFundDocumentEntity::getCounterpartyNameSnapshot,
                    criteria.counterpartyName());
        if (criteria.handlerStaffCode() != null)
            query.eq(InternalFundDocumentEntity::getHandlerStaffCode, criteria.handlerStaffCode());
        if (criteria.settlementMethodCode() != null)
            query.eq(
                    InternalFundDocumentEntity::getSettlementMethodCode,
                    criteria.settlementMethodCode());
        if (criteria.businessTypeCode() != null)
            query.eq(InternalFundDocumentEntity::getBusinessTypeCode, criteria.businessTypeCode());
        if (criteria.documentStatusCode() != null)
            query.eq(
                    InternalFundDocumentEntity::getDocumentStatusCode,
                    criteria.documentStatusCode());
        if (criteria.occurredTimeFrom() != null)
            query.ge(
                    InternalFundDocumentEntity::getOccurredTime,
                    local(criteria.occurredTimeFrom()));
        if (criteria.occurredTimeTo() != null)
            query.le(InternalFundDocumentEntity::getOccurredTime, local(criteria.occurredTimeTo()));
        return scopes.applyRelated(query, "order:fund:read", "order_fund_document");
    }

    private InternalFundDocumentEntity entity(
            String tenantId,
            String documentNo,
            FundDocumentWrite command,
            String actorId,
            LocalDateTime now) {
    ...
    private static FundDocumentSummaryView summary(InternalFundDocumentEntity entity) {
        return new FundDocumentSummaryView(
                entity.getId(),
                entity.getDocumentNo(),
                uuid(entity.getConnectorId()),
                entity.getSourceSystemCode(),
                entity.getDirectionCode(),
                entity.getRelatedOrderId(),
                entity.getSalesOrderNoSnapshot(),
                entity.getCustomerId(),
                entity.getCustomerCodeSnapshot(),
                entity.getCustomerNameSnapshot(),
                entity.getCounterpartyTypeCode(),
                entity.getCounterpartyCodeSnapshot(),
                entity.getCounterpartyNameSnapshot(),
                entity.getHandlerStaffCode(),
                entity.getHandlerStaffNameSnapshot(),
                instant(entity.getOccurredTime()),
                entity.getSettlementMethodCode(),
                entity.getBusinessTypeCode(),
                entity.getDocumentStatusCode(),
                entity.getAmount(),
                entity.getSourceDocumentNo(),
                entity.getSourceOrderNo(),
                entity.getPaymentSerialNo(),
                entity.getBankAccountName(),
                entity.getBankName(),
                entity.getBankAccountNo(),
                instant(entity.getSubmittedAt()),
                instant(entity.getConfirmedAt()),
                parseStrings(entity.getSourceAttachmentKeysJson()),
                entity.getRevision(),
    ...
    private static FundDocumentDetailView detail(InternalFundDocumentEntity entity) {
        return new FundDocumentDetailView(
                ...
                instant(entity.getConfirmedAt()),
                parseStrings(entity.getSourceAttachmentKeysJson()),
                parseStrings(entity.getVoucherKeysJson()),
                List.of(),
                entity.getRemark(),
                entity.getRevision(),
                entity.getCreatedBy(),
