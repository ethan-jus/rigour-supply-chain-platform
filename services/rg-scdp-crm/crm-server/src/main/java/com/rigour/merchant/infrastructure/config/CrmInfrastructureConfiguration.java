...
public class CrmInfrastructureConfiguration {
    ...
    MybatisPlusCrmRepository crmRepository(
            ...
            Clock crmClock,
            com.rigour.merchant.infrastructure.persistence.repository.CrmDataScope scopes,
            com.rigour.merchant.infrastructure.persistence.repository.CrmResponsibilityWriter
                    responsibilities,
            com.rigour.merchant.infrastructure.persistence.repository.CustomerIdentityGuard identities) {
        return new MybatisPlusCrmRepository(
                customerTypeMapper,
                customerAreaMapper,
                partyMapper,
                partyRoleMapper,
