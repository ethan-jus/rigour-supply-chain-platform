...
public class InternalCustomerEntity {
    // 客户真实建档事实；与系统入库审计分离，未知来源不得回退到导入时间。
    private LocalDateTime businessCreatedAt;
    public LocalDateTime getBusinessCreatedAt() { return businessCreatedAt; }
    public void setBusinessCreatedAt(LocalDateTime value) { businessCreatedAt = value; }
    private String businessCreatedById;
    public String getBusinessCreatedById() { return businessCreatedById; }
    public void setBusinessCreatedById(String value) { businessCreatedById = value; }
    private String businessCreatedByName;
    public String getBusinessCreatedByName() { return businessCreatedByName; }
    public void setBusinessCreatedByName(String value) { businessCreatedByName = value; }
    private String businessCreationSource;
    public String getBusinessCreationSource() { return businessCreationSource; }
    public void setBusinessCreationSource(String value) { businessCreationSource = value; }

    private String ownerManagementMode;
    private String regionManagementMode;
    private Long ownerRevision;
    private Long regionRevision;

    public String getOwnerManagementMode() {
        return ownerManagementMode;
    }

    public void setOwnerManagementMode(String value) {
        ownerManagementMode = value;
    }

    public String getRegionManagementMode() {
        return regionManagementMode;
    }

    public void setRegionManagementMode(String value) {
        regionManagementMode = value;
    }
    ...
    public void setOwnerRevision(Long value) {
        ownerRevision = value;
    }

    public Long getRegionRevision() {
        return regionRevision;
    }

    public void setRegionRevision(Long value) {
    ...
    public void setSyncedBy(String value) { this.syncedBy = value; }
}
