 ...
 * CRM 自研客户管理接口。
 *
 * <p>客户主档由 CRM 维护，收货信息独立保存并通过客户的 Party 关联；接口不直接调用订货宝。</p>
 */
public interface CrmInternalCustomerApi {
    ...
    ApiResponse<PageView<InternalCustomerSummaryView>> customers(
            ...
            @RequestParam(defaultValue = "businessCreatedAt") String sortBy,
    ...
    ApiResponse<java.util.List<String>> creators();
