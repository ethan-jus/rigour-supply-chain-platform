...
public record InternalCustomerCommand(
        ...
        Integer revision,
        String loginAccount,
        CustomerShippingAddressCommand shippingAddress) {
    public InternalCustomerCommand(
        String customerName,
        String contactName,
        String contactPhone,
        String customerTypeCode,
        ...
        String remark,
        Integer revision,
        String loginAccount) { this(customerName, contactName, contactPhone, customerTypeCode, regionCode, ownerSalesUserId, ownerSalesName, ownerEmployeeCode, ownerEmployeeNameSnapshot, settlementTypeCode, address, statusCode, remark, revision, loginAccount, null); }
    ...
    public InternalCustomerCommand(
        ...
        String remark,
        Integer revision) {
        this(customerName, contactName, contactPhone, customerTypeCode, regionCode, ownerSalesUserId, ownerSalesName, ownerEmployeeCode, ownerEmployeeNameSnapshot, settlementTypeCode, address, statusCode, remark, revision, null);
    }
